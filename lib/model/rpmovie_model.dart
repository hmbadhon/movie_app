...
//
//     final rpSingleMoviesModel = rpSingleMoviesModelFromJson(jsonString);

import 'dart:convert';

RpSingleMoviesModel rpSingleMoviesModelFromJson(String str) =>
    RpSingleMoviesModel.fromJson(json.decode(str));

String rpSingleMoviesModelToJson(RpSingleMoviesModel data) =>
    json.encode(data.toJson());

class RpSingleMoviesModel {
  RpSingleMoviesModel({
    this.adult,
    this.backdropPath,
  ...
  factory RpSingleMoviesModel.fromJson(Map<String, dynamic> json) =>
      RpSingleMoviesModel(
